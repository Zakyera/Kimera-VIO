...
class CbsFixedLagBpsamHeart {
 public:
  ...
  struct SummaryBuildStats {
    ...
    size_t boundary_crossing_factor_slots_count = 0u;
    std::string boundary_crossing_factor_slots_first_few = "none";
    size_t local_crossing_factor_slots_count = 0u;
    std::string local_crossing_factor_slots_first_few = "none";
    size_t nonbelief_local_crossing_factor_slots_count = 0u;
    std::string nonbelief_local_crossing_factor_slots_first_few = "none";
    size_t selected_local_nonbelief_crossing_factor_slots_count = 0u;
    std::string selected_local_nonbelief_crossing_factor_slots_first_few =
        "none";
    ...
    size_t boundary_candidate_crossing_factor_slots_count_raw = 0u;
    std::string boundary_candidate_crossing_factor_slots_first_few_raw = "none";
    ...
    long long first_rejected_crossing_slot = -1;
    std::string first_rejected_crossing_slot_class = "none";
    std::string first_rejected_crossing_slot_keys = "none";
    std::string first_rejected_crossing_reason = "none";
